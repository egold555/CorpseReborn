...
import org.golde.bukkit.corpsereborn.nms.nmsclasses.packetlisteners.Pcktin_1_9_R2;
...
public class NMSCorpses_v1_9_R2 implements Corpses {
	...
	public CorpseData spawnCorpse(Player p, Inventory inv) {
		...
		DataWatcherObject<Float> obj = new DataWatcherObject<Float>(10, DataWatcherRegistry.c);
	...
	public void registerPacketListener(Player p) {
		Pcktin_1_9_R2.registerListener(p);
	}
